...
export default function ProductsPage() {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (product: Product) => (
        <span className="fz-14 font-semibold text-foreground">
    ...
    },
    {
      ...
      headerClassName: "w-[100px]",
      render: (product: Product) => (
        <span className="fz-14 text-muted-foreground">
    ...
    },
    {
      ...
      headerClassName: "w-[100px]",
      render: (product: Product) => (
        <span className="fz-14 font-medium text-foreground">
          {product.order}
        </span>
      ),
    },
    {
      ...
      render: (product: Product) => (
        <span
          className={`inline-flex items-center px-3 py-1 rounded-full fz-12 font-medium shadow-sm ${
            product.isActive
